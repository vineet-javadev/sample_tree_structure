...
const OnuNode = ({ id, data, isConnectable }) => {
  ...
  return (
    <div
      ...
      } justify-center rounded bg-gradient-to-b from-pink-500 to-purple-500 text-black  w-[220px]`}
    >
      <div className="block w-full rounded-lg bg-success text-black shadow-secondary-1">
        ...
        <div className="p-4">
          <div
            className="flex  gap-2 flex-wrap px-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          >
              {portElements}
          </div>
        </div>
