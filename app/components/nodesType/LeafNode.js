...
const LeafNode = ({ id, data, isConnectable }) => {
  ...
  return (
    <div
      ...
      } justify-center rounded bg-yellow-300 text-black`}
    >
      <div className="block max-w-[18rem] rounded-lg bg-success text-black shadow-secondary-1">
      ...
      <p className="text-base">
        ...
        bulk of the cards content.
          ...
          <select
            className="pr-5 z-10 bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 "
            onChange={(e) => {
